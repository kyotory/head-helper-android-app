...
public final class ActivityAttendanceBinding implements ViewBinding {
  ...
  @NonNull
  public final TableLayout tableAttendance;

  private ActivityAttendanceBinding(@NonNull LinearLayout rootView, @NonNull TextView dateTextView,
      @NonNull TableLayout tableAttendance) {
  ...
  public static ActivityAttendanceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tableAttendance;
      TableLayout tableAttendance = ViewBindings.findChildViewById(rootView, id);
      if (tableAttendance == null) {
        break missingId;
      }

      return new ActivityAttendanceBinding((LinearLayout) rootView, dateTextView, tableAttendance);
    }
